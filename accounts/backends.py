...
class CaseInsensitiveAuth:
    ...
    updateing your User model to save usernames as lower case entries to 
    the database.
    ...
    def authenticate(self, username_or_email=None, password=None):
        """
        Get an instance of User using the suppplied username
...
class EmailAuth:
    ...
    def get_user(self, user_id):
        """Used by the Django authenticaion system to retrieve a user instance"""
